...
def run():
    ...
    # gps_plotter.plot_gps_deviation(baseline="externalACM0_GPS", comparison="internal_GPS", style="map")

    gps_model_tool.create_model(gps_file="internal_GPS", model_name="GpsModels-internal")
    gps_model_tool.use_model(model_name="GpsModels-internal", seconds_to_simulate=15)
