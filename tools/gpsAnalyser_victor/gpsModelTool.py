...
from tools.gpsAnalyser_victor.utils.orderPoints import order_points_neighbors_duplicates, order_points_neighbors
    ...
    def generate_heatmap(self, gps_file_name, plot=True):
        ...
        for i_compare in range(len(comparison_coord)):
            ...
            if not closest_index is None:
                ...
                print(time, baseline_interpolation_times[closest_index], coord, baseline_interpolation[closest_index])
