...
class TransmissionScenario(sr.ScenarioRoute):
    ...
    def __init__(self, repeats, gap_between_repeats):
        ...
        super(TransmissionScenario, self).__init__(name=name, number_bikes=number_bikes, number_cars=number_cars,
    ...
    def create_route_file(self):
        ...
        with open("simulationData/cross.rou.xml", "w") as routes:
            ...
            print("<vType id='type_car' accel='2' decel='4.5' sigma='0.8' tau='0.6' length='5' minGap='2.5' maxSpeed='10' "
            ...
            print("<vType id='type_bike' accel='1.2' decel='3' sigma='0.8' tau='0.3' length='1.6' minGap='1' maxSpeed='5' "
                  "jmIgnoreFoeProb='%i' jmIgnoreJunctionFoeProb='%i' impatience='%i' guiShape='bicycle'/>"
                  % (self.jmIgnoreFoeProb, self.jmIgnoreJunctionFoeProb, self.impatience),
                  file=routes)

            print("<route id='left_stand' edges='51o 1i' />", file=routes)
            ...
            for r in range(self.repeats):
                ...
                print('<vehicle id="car_straight_%i" type="type_car" route="right_straight" depart="%i" />' %
