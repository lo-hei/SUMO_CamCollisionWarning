...
import simulation_classes.CollisionWarningAlgorithm.radiusCWA as radiusCWA
import simulation_classes.CollisionWarningAlgorithm.radiusInterpolationCWA as radiusInterpolationCWA
